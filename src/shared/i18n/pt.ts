...
export const pt: Partial<Record<Key, string>> = {
  ...
  'empty.hint': 'Duplo clique para uma pasta · clique direito em qualquer lugar para um URL',
  'empty.urlBack': 'Clique direito para voltar',
  ...
  'set.sec.audio': 'Áudio',
  'set.sec.subtitles': 'Legendas',
  'set.tab.playback': 'Reprodução',
  'set.tab.subs': 'Legendas',
  ...
  'set.resumePlaylist.desc':
    'Reabrir um ficheiro ou link de lista regressa ao último vídeo visto nela.',
  ...
  'set.ytdl.label': 'Suporte a vídeo online',
  'set.ytdl.desc':
    'O vídeo online é resolvido pelo yt-dlp, que o Lunoir atualiza sozinho a cada duas semanas, aproximadamente.\nAtualize-o à mão se um site deixar de reproduzir: mudam com frequência, e um yt-dlp antigo é a causa habitual.',
  'set.ytdl.update': 'Atualizar agora',
  'set.ytdl.working': 'A transferir…',
  'set.ytdl.done': 'Atualizado para a versão mais recente',
  'set.ytdl.failed': 'Não foi possível atualizar — verifique a ligação',
  'main.ytdlUpdated': 'Suporte a vídeo online atualizado — tente novamente',
