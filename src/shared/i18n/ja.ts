...
export const ja: Partial<Record<Key, string>> = {
  ...
  'set.sec.audio': '音声',
  'set.sec.subtitles': '字幕',
  'set.tab.playback': '再生',
  'set.tab.subs': '字幕',
  'set.tab.interface': '表示',
  'set.tab.general': '全般',
  ...
  'set.hwdec.auto': 'GPU デコード。最も効率的で、ほとんどの場合こちらが正解です。',
  'set.hwdec.autoCopy':
    'デコードは GPU のままですが、各フレームをシステムメモリーに戻します。デコード自体は動いているのに映像がおかしい場合（ティアリング、ブロックノイズ、色の異常）にだけ試す価値があります。',
  'set.hwdec.off':
    'CPU でデコードします。最も互換性が高く、最後に試す選択肢です。4K では負荷が大きくなります。',
  ...
  'menu.hideTitleBar': 'タイトルバーを隠す',
  'menu.mini': 'ミニプレーヤー',
  'mini.exit': 'ミニプレーヤーを終了',
  'menu.home': 'ホームに戻る',
  ...
  'set.ytdl.label': 'オンライン動画のサポート',
  'set.ytdl.desc':
    'オンライン動画は yt-dlp が解析します。Lunoir が 2 週間おき程度に自動で更新します。\nサイトが再生できなくなったら手動で更新してください。サイト側の変更は頻繁で、yt-dlp が古いのが主な原因です。',
  'set.ytdl.update': '今すぐ更新',
  'set.ytdl.working': 'ダウンロード中…',
  'set.ytdl.done': '最新バージョンに更新しました',
  'set.ytdl.failed': '更新できませんでした — 接続を確認してください',
  'main.ytdlUpdated': 'オンライン動画のサポートを更新しました — もう一度お試しください',
