...
export const zhCN: Partial<Record<Key, string>> = {
  ...
  'set.hwdec.auto': 'GPU 解码。效率最佳，绝大多数情况都该用这一档。',
  'set.hwdec.autoCopy':
    '仍由 GPU 解码，但把每一帧都拷回内存。只有在解码本身正常、画面却不对劲时（撕裂、花块、颜色异常）才值得一试。',
  'set.hwdec.off': '由 CPU 解码。兼容性最好，也是最后才试的一档；4K 下开销很大。',
  'set.deint.label': '反交错',
  'set.deint.desc':
  ...
  'set.ytdl.label': '在线视频支持',
  'set.ytdl.desc':
    '在线视频由 yt-dlp 解析,Lunoir 每隔两周左右会自动更新它。\n如果某个网站突然放不了,可以手动更新一次 —— 网站改动频繁,多半就是 yt-dlp 版本旧了。',
  'set.ytdl.update': '立即更新',
  'set.ytdl.working': '正在下载…',
  'set.ytdl.done': '已更新到最新版本',
  'set.ytdl.failed': '更新失败 —— 请检查网络连接',
  'main.ytdlUpdated': '在线视频支持已更新 —— 请重试',
