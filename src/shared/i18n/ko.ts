...
export const ko: Partial<Record<Key, string>> = {
  ...
  'set.sec.audio': '오디오',
  'set.sec.subtitles': '자막',
  'set.tab.playback': '재생',
  'set.tab.subs': '자막',
  'set.tab.interface': '인터페이스',
  'set.tab.general': '일반',
  ...
  'set.hwdec.auto': 'GPU 디코딩. 가장 효율적이며 거의 모든 경우 이 항목이 정답입니다.',
  'set.hwdec.autoCopy':
    '디코딩은 여전히 GPU에서 하지만 모든 프레임을 시스템 메모리로 다시 복사합니다. 디코딩 자체는 되는데 화면이 이상할 때(찢어짐, 블록 노이즈, 색 이상)만 시도해 볼 가치가 있습니다.',
  'set.hwdec.off':
    'CPU에서 디코딩합니다. 호환성이 가장 높고 마지막으로 시도할 항목이며, 4K에서는 부하가 큽니다.',
  ...
  'menu.hideTitleBar': '제목 표시줄 숨기기',
  'menu.mini': '미니 플레이어',
  'mini.exit': '미니 플레이어 종료',
  'menu.home': '홈으로 돌아가기',
  'menu.openFile': '파일 열기…',
  'menu.openUrl': 'URL 열기…',
  ...
  'set.ytdl.label': '온라인 동영상 지원',
  'set.ytdl.desc':
    '온라인 동영상은 yt-dlp가 해석하며, Lunoir가 2주에 한 번 정도 알아서 업데이트합니다.\n어떤 사이트가 재생되지 않으면 수동으로 업데이트하세요. 사이트는 자주 바뀌고, 오래된 yt-dlp가 흔한 원인입니다.',
  'set.ytdl.update': '지금 업데이트',
  'set.ytdl.working': '다운로드 중…',
  'set.ytdl.done': '최신 버전으로 업데이트했습니다',
  'set.ytdl.failed': '업데이트하지 못했습니다 — 연결을 확인하세요',
  'main.ytdlUpdated': '온라인 동영상 지원을 업데이트했습니다 — 다시 시도하세요',
