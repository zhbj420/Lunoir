...
export const ru: Partial<Record<Key, string>> = {
  ...
  'set.deint.label': 'Деинтерлейсинг',
  'set.deint.desc':
    'Вещательное видео (1080i, 576i — большинство телеканалов, DVD и телезаписи) хранит каждый кадр как два полукадра половинной высоты, снятых с разницей в доли секунды. На современном экране это видно как гребёнка на движущихся краях.\n«Авто» вмешивается только если источник сам заявляет чересстрочность; прогрессивное видео не трогается. Включите принудительно, если канал помечен неверно.',
  ...
  'opt.deint.auto': 'Авто (если источник чересстрочный)',
