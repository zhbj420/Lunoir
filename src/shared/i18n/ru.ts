...
export const ru: Partial<Record<Key, string>> = {
  ...
  'set.sec.audio': 'Аудио',
  'set.sec.subtitles': 'Субтитры',
  'set.tab.playback': 'Воспроизведение',
  'set.tab.subs': 'Субтитры',
  'set.tab.interface': 'Интерфейс',
  'set.tab.general': 'Общие',
  'set.sec.subAppearance': 'Вид субтитров',
  'set.sec.video': 'Видео',
  'set.sec.enhance': 'Улучшение',
  'set.enhance.label': 'Улучшить изображение',
  'set.enhance.desc':
    'Главный переключатель инструментов ниже. Для качественных источников оставьте выключенным — он помогает только низкокачественному ТВ и IPTV и размывает чёткое изображение.\nПри выключении настройки сохраняются, включить можно в любой момент.',
  'set.deblock.label': 'Деблокинг',
  'set.deblock.desc':
    'Убирает блочность и «москитный» шум сильно сжатого видео — большинство каналов и IPTV.\nЧем выше, тем чище, но тем больше нагрузка на CPU. Для хороших источников выключайте: чистое видео размягчается.',
  'opt.deblock.off': 'Выкл.',
  'opt.deblock.low': 'Низк.',
  'opt.deblock.mid': 'Средн.',
  'opt.deblock.high': 'Выс.',
  'set.nr.label': 'Шумоподавление',
  'set.nr.desc':
    'Сглаживает шум сжатия и зерно, оставшиеся после деблокинга. Только пространственное, поэтому никогда не тянет шлейфы на движении — но может смягчить мелкие детали.\nДля шумного ТВ; на чистых источниках отключите.',
  'set.sharpen.label': 'Резкость',
  'set.sharpen.desc': 'Делает мягкое низкокачественное видео чётче. Немного — уже много; перебор возвращает шум.',
  'set.artcnn.label': 'Детали (ArtCNN)',
  'set.artcnn.desc':
    'Нейросетевая 2× реконструкция детализации яркости на источниках низкого разрешения — наибольший прирост для мягкого, малодетального видео. Не работает при родном разрешении.\nНагружает GPU; лучше на чистом, но малодетальном контенте, а не на шумных потоках.',
  'set.cfl.label': 'Цвет (CfL)',
  'set.cfl.desc':
    'Восстанавливает цветовую детализацию по каналу яркости (chroma-from-luma) — чище цветные края и меньше растекания на видео 4:2:0.\nЕле заметно; помогает в основном на насыщенных краях и цветном тексте.',
  ...
  'set.resumePlaylist.desc':
    'Повторное открытие файла или ссылки на плейлист возвращает к последнему просмотренному видео.',
  ...
  'set.hwdec.auto': 'Декодирование на GPU. Самое эффективное и почти всегда правильный выбор.',
  'set.hwdec.autoCopy':
    'По-прежнему декодирует на GPU, но копирует каждый кадр обратно в системную память. Пробовать стоит только если изображение неверное — разрывы, блоки или странные цвета — а декодирование в остальном работает.',
  'set.hwdec.off':
    'Декодировать на CPU. Самый совместимый вариант и последний, который стоит пробовать; дорого в 4K.',
  ...
  'menu.hideTitleBar': 'Скрыть заголовок окна',
  'menu.mini': 'Мини-плеер',
  'mini.exit': 'Выйти из мини-плеера',
  ...
  'set.ytdl.label': 'Поддержка онлайн-видео',
  'set.ytdl.desc':
    'Онлайн-видео разбирает yt-dlp, который Lunoir сам обновляет примерно раз в две недели.\nОбновите вручную, если сайт перестал воспроизводиться: они часто меняются, и устаревший yt-dlp — обычная причина.',
  'set.ytdl.update': 'Обновить сейчас',
  'set.ytdl.working': 'Загрузка…',
  'set.ytdl.done': 'Обновлено до последней версии',
  'set.ytdl.failed': 'Не удалось обновить — проверьте подключение',
  'main.ytdlUpdated': 'Поддержка онлайн-видео обновлена — попробуйте снова',
