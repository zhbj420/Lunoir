...
export const es: Partial<Record<Key, string>> = {
  ...
  'lib.clearRecents': 'Vaciar',
  'lib.clearConfirm': '¿Vaciar todo?',
  ...
  'set.oscStyle.label': 'Estilo de los controles',
  'set.oscStyle.desc1':
    'Flotante: una barra compacta sobre la imagen, que se oculta tras un momento de inactividad.',
  'set.oscStyle.desc2':
    'Acoplada: a todo lo ancho, en la parte inferior de la ventana. En modo ventana el vídeo le deja sitio, así que nunca tapa la imagen ni se oculta.',
  ...
  'opt.oscStyle.floating': 'Flotante',
  ...
  'info.title': 'Información del archivo',
  'info.video': 'Vídeo',
  'info.audio': 'Audio',
  'info.codec': 'Códec',
  'info.resolution': 'Resolución',
  'info.frameRate': 'Fotogramas/s',
  'info.overallBitRate': 'Tasa de bits global',
  'info.fileSize': 'Tamaño del archivo',
  'info.bitRate': 'Tasa de bits de video',
  'info.bitDepth': 'Profundidad de bits',
  'info.colorSpace': 'Espacio de color',
  'info.hdr': 'HDR',
  'info.container': 'Contenedor',
  'info.duration': 'Duración',
  'info.noData': 'No hay información de medios disponible'
}
